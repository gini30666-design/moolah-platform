...
const S = [
  ...
  // ── 美甲（6）
  ['美甲・單色', 900, 60, '可跳一色。含基礎保養、加厚、卸甲。足部 +200。單指裝飾 +$20~100/指（現場計算）。純卸甲本店 200／他店 300（足部 400／500）。'],
  ...
  // ⚠️ 卸甲刻意不獨立上架：她的美甲各項本來就「含卸甲」，
  //    單獨列 NT$200 會讓職人頁的「NT$ ___ 起」變成 200，
  //    客人一眼看到會誤判她的定價帶（實際主力 900–6500）。
  //    純卸甲的價格寫在美甲各項說明裡，客人有需要會私訊。
  //    → 她若堅持要單獨上架，後台自己加即可。
  // ── 其他（2）
  ['野生眉雕塑', 1000, 40, ''],
