...
二、方案與試用
新加入享 14 天免費試用（全功能，試用期間預約上限 30 筆）。試用期自第一筆線上預約成立之日起算，在此之前不計時。試用期滿轉標準方案 NT$699／月；不需試用者可直接正式加入。工作室方案依規模另行報價。客製立牌於正式加入後免費提供。試用期滿未續約，後台暫停、資料保留 30 天。MooLah 保留依市場調整定價之權利，並提前 30 天通知。
            ...
            <div style={{ display: 'inline-block', padding: '6px 14px', borderRadius: '999px', background: 'rgba(166,137,102,0.14)', border: '1px solid rgba(166,137,102,0.35)', marginBottom: '24px' }}>
              ...
              <span style={{ fontSize: '12px', color: oak, fontWeight: 600 }}>
                {presetPlan === 'active' || direct
                  ? '正式合作 · 0% 抽佣・不綁約'
                  : '14 天免費試用 · 全功能・上限 30 筆預約 · 第一筆預約後才起算'}
              </span>
            </div>
