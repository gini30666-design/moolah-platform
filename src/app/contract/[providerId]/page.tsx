...
const CLAUSES = [
  ...
  ['二、方案與試用', '新加入享 14 天免費試用（全功能，試用期間預約上限 30 筆）。試用期滿轉標準方案 NT$699／月；不需試用者可直接正式加入。工作室方案依規模另行報價。客製立牌於正式加入後免費提供。試用期滿未續約，後台暫停、資料保留 30 天。MooLah 保留依市場調整定價之權利，並提前 30 天通知。'],
