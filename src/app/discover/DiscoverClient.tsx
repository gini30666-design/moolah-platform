...
// 快速選項＝目前真的有職人進駐的縣市（新職人上線時記得補進來，否則客人要多點一層「其他縣市」）
const QUICK_CITIES = ['高雄市', '台南市', '台中市', '台北市', '新北市', '桃園市', '新竹市', '屏東縣']
const TW_CITIES = [
...
export default function DiscoverClient({ initialCategory }: { initialCategory: string }) {
