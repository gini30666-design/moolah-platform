...
const CATEGORY_MAP: Record<string, {
  ...
  'ear-cleaning': {
    ...
    en: 'Ear Spa',
    emoji: '👂',
    title: '採耳・耳燭線上預約 | 專業採耳師 LINE 一鍵預約',
    description: '採耳、耳燭、耳部 SPA 線上預約平台。專業採耳師提供可視採耳與耳道護理，透過 LINE 一鍵預約，即時看空檔、到店付款、自動提醒。',
    hero: '給耳朵一場深度放鬆',
    intro: 'MooLah 嚴選專業採耳師。可視採耳、耳燭放鬆、耳部 SPA，每位採耳師都附服務說明與價格，透過 LINE 一鍵預約，不需下載 App。',
    benefits: [
      '可視採耳過程透明，安心體驗',
      '服務時長與價格預約前一目瞭然',
      '系統自動記錄回訪週期，LINE 提醒你',
      '到店付款、免訂金，取消改期都在 LINE 完成',
    ],
    faq: [
      { q: '採耳安全嗎？', a: '合作採耳師以專業器具與可視設備操作，過程輕柔透明。耳道敏感或有病史者建議先諮詢醫師。' },
      { q: '多久採一次比較好？', a: '一般建議 3–4 週一次。預約完成後，MooLah 會在建議回訪時間透過 LINE 自動提醒你。' },
      { q: '採耳跟耳燭可以一起做嗎？', a: '多數採耳師提供組合療程，預約頁會列出各項服務與時長，可直接選擇含耳燭的方案。' },
    ],
  },
  // 2026-08-13 新品類：Google 台灣月搜量 皮膚管理 5,400／頭療 6,600（皆 LOW–MEDIUM 競爭）。
  // ⚠️ 刻意只做「全台級」大字頁，不進 localSeo.CATEGORIES —— 那會自動展開 19 城 × 1 品類 = 19 頁，
  //    而城市級搜尋量只有 100–170/月（對照「高雄採耳」590），在職人數還少時等於灌薄內容頁。
  'skin-care': {
    zh: '皮膚管理師',
    en: 'Skin Care',
    emoji: '✨',
    title: '皮膚管理・肌膚管理線上預約 | 韓式皮膚管理工作室 LINE 一鍵預約',
    description: '皮膚管理、肌膚管理、韓式皮膚管理線上預約平台。水飛梭、手工清粉刺、科技護膚、客製化調理，透過 LINE 一鍵預約，即時看空檔、到店付款、自動提醒。',
    hero: '把肌膚交給懂它的人',
    intro: 'MooLah 嚴選皮膚管理工作室。韓式皮膚管理、水飛梭、手工清粉刺、科技護膚與客製化調理，每間工作室都附服務說明與價格，透過 LINE 一鍵預約，不需下載 App、不需註冊。',
    benefits: [
      '療程時長不一樣也排得準，系統依項目自動鎖時段',
      '課程與單堂價格公開透明，不怕臨場被推銷',
      '膚況與上次做的療程系統會記錄，回訪自動 LINE 提醒',
      '到店付款、免訂金，改期取消都在 LINE 完成',
    ],
    faq: [
      { q: '皮膚管理跟一般做臉差在哪？', a: '皮膚管理多為「療程式」的長期規劃——依膚況安排週期、搭配儀器與院線品保養品；一般做臉偏單次深層清潔。實際內容依各工作室的服務說明為準，預約頁都會列出項目、時長與價格。' },
      { q: '水飛梭、科技護膚這類療程時間比較長，預約得到嗎？', a: '可以。每個服務項目都可各自設定時長，系統會依你選的項目自動計算並鎖住需要的時段，不會發生兩位客人撞到同一段時間。' },
      { q: '第一次去需要先諮詢嗎？', a: '多數工作室會在療程前做膚況評估，不需額外跑一趟。預約時在備註寫下你的膚況與在意的問題（粉刺、痘痘、泛紅、毛孔），到店溝通會更有效率。' },
    ],
  },
  'head-spa': {
    zh: '頭療師',
    en: 'Head Spa',
    emoji: '🌿',
    title: '頭療・頭皮SPA線上預約 | Head Spa 舒眠頭療 LINE 一鍵預約',
    description: '頭療、頭皮SPA、舒眠頭療、肩頸紓壓線上預約平台。專業頭療工作室採預約制，可選香氛與精油，透過 LINE 一鍵預約，即時看空檔、到店付款、自動提醒。',
    hero: '讓腦袋真正安靜下來',
    intro: 'MooLah 嚴選頭療工作室。舒眠頭療、頭皮護理、肩頸紓壓與夜間洗頭，多為一人作業的預約制空間，每間都附服務說明與價格，透過 LINE 一鍵預約，不需下載 App。',
    benefits: [
      '晚間時段也約得到，系統支援全天營業時間設定',
      '一人作業工作室最合適，時段鎖住就不會被打斷',
      '香氛與加購項目在預約頁就選好，到店直接開始',
      '到店付款、免訂金，改期取消都在 LINE 完成',
    ],
    faq: [
      { q: '頭療跟一般洗頭差在哪？', a: '頭療著重頭皮健康與放鬆，通常包含頭皮檢測或清潔、按摩手技與精油／香氛選擇，時間也較長。實際流程依各工作室的服務說明為準，預約頁會列出項目、時長與價格。' },
      { q: '可以約晚上的時段嗎？', a: '可以。MooLah 的營業時間由職人自行設定，支援到深夜的時段，很多頭療工作室都有開晚間或夜間洗頭的班。實際可約時間以該職人的預約頁為準。' },
      { q: '需要提前多久預約？', a: '頭療工作室多為一人作業、全預約制，建議提前幾天。預約完成後你和職人會各收到一張 LINE 通知卡，前一天系統也會自動提醒。' },
    ],
  },
  'facial': {
    zh: '美容師',
    en: 'Facial Care',
    emoji: '🧖',
    title: '做臉・清粉刺線上預約 | 專業美容師 LINE 一鍵預約',
    description: '做臉、清粉刺、深層清潔線上預約平台。專業美容師工作室，無痛清粉刺、保濕護理，透過 LINE 一鍵預約，即時看空檔、到店付款。',
    hero: '還你一張乾淨透亮的臉',
    intro: 'MooLah 嚴選專業美容師。深層清潔做臉、無痛清粉刺、課程保養，每位美容師都附服務說明與價格，透過 LINE 一鍵預約。',
    benefits: [
      '預約備註可說明膚況，美容師提前準備',
      '服務項目與價格透明，不怕被推銷',
      '系統記錄保養週期，回訪自動提醒',
      '到店付款、免訂金，改期取消都在 LINE',
    ],
    faq: [
      { q: '做臉多久做一次？', a: '一般建議 3–4 週一次深層清潔，配合角質代謝週期。MooLah 會在建議回訪時間自動 LINE 提醒。' },
      { q: '清粉刺會痛嗎？', a: '多數合作美容師提供無痛手法；敏感肌可在預約備註註明，美容師會調整流程。' },
      { q: '會不會被推銷課程或產品？', a: 'MooLah 合作職人以服務本身為主，所有項目價格在預約頁公開透明，可安心體驗。' },
    ],
  },
  'massage': {
    zh: '按摩舒壓師',
    en: 'Massage & Spa',
    emoji: '💆',
    title: '按摩・舒壓線上預約 | 腳底按摩精油舒壓 LINE 一鍵預約',
    description: '按摩舒壓線上預約平台。腳底按摩、精油舒壓、肩頸放鬆，專業按摩師即時看空檔、LINE 一鍵預約、到店付款免訂金。',
    hero: '把疲勞留在今天',
    intro: 'MooLah 嚴選專業按摩舒壓師。腳底按摩、精油舒壓、肩頸放鬆、全身指壓，每位職人都附服務說明與價格，透過 LINE 一鍵預約。',
    benefits: [
      '可預約時段一目瞭然，不用電話詢問',
      '服務時長與價格透明，到店付款免訂金',
      '前一天 LINE 自動提醒，不怕忘記',
    ...
    faq: [
      { q: '按摩前後要注意什麼？', a: '建議飯後隔 1 小時再按摩、按摩後多補充溫水。孕期或有特殊病史請在預約備註註明。' },
      { q: '腳底按摩跟精油舒壓怎麼選？', a: '腳底按摩以穴位刺激消除疲勞；精油舒壓著重全身放鬆與睡眠品質，預約頁有詳細說明可參考。' },
      { q: '需要先付訂金嗎？', a: '不用。MooLah 預約採到店付款，線上選好時段送出即完成預約。' },
    ],
  },
}
