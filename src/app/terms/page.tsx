...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://moolah.studio/terms',
    languages: {
      'zh-Hant-TW': 'https://moolah.studio/terms',
      'x-default': 'https://moolah.studio/terms',
    },
  },
}
...
const SECTIONS = [
  {
    title: '一、服務說明',
    content: `MooLah 是由永翔數位有限公司營運的美業預約媒合平台，提供消費者與合作職人（髮型設計師、寵物美容師、汽車美容師、美甲師）之間的線上預約服務。
...
如遇消費糾紛，建議雙方先行協商，必要時可聯絡 MooLah 協助調處。`,
  ...
  {
    title: '七、智慧財產權',
    content: `MooLah 平台所有內容，包含但不限於文字、圖片、設計、程式碼，均受著作權法保護，屬永翔數位有限公司所有。
