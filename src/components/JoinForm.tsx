  ...
  if (status === 'success') {
    return (
      <div style={{ textAlign: 'center', padding: '48px 24px' }}>
        ...
        {/* ⚠️ 原本寫「24 小時內」——那是在給自己台階下，也給了對方去看別家的時間。
            2026-08-13 顧問：新 lead 是有熱度的，半小時後他可能已經在研究另一家。
            後端現在會即時推播給業務，所以承諾得起 10 分鐘。 */}
        <p style={{ fontSize: '14px', color: 'rgba(44,40,37,0.74)', lineHeight: 1.7, marginBottom: '20px' }}>
          我們會在 <strong style={{ color: 'var(--oak)' }}>10 分鐘內</strong>透過你留的方式聯絡你。<br/>
          等待的時候，可以先看看客人那一端長什麼樣 👇
        </p>
        {/* 填完到有人回覆之間的空窗，用真實示範頁填掉，不要讓他乾等 */}
        <a href="/designer-003" style={{
          display: 'inline-block', marginBottom: '20px', fontSize: '13.5px',
          color: 'var(--charcoal)', textDecoration: 'underline', textUnderlineOffset: '4px',
        }}>
          看真實職人的預約頁 →
        </a>
        <div style={{ height: '8px' }} />
        <LineLink source="join_form_1" oaId={OA_B2B} track style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 24px', background: '#06C755', color: 'white', fontSize: '13px', letterSpacing: '0.08em', borderRadius: '4px', textDecoration: 'none', }}>
