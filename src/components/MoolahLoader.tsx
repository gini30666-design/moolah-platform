  ...
  return (
    ...
    >
      <style>{`
        ...
        @keyframes ml-breathe { 0%,100% { transform: scale(1) } 50% { transform: scale(1.02) } }
        ...
        .ml-m {
          font-size: 116px; font-weight: 500; line-height: 1; letter-spacing: -0.01em;
          color: #A98A5E;
        }
        ...
        @media (prefers-reduced-motion: reduce) {
          .ml-breathe, .ml-dot, .ml-track > span { animation: none !important; }
        }
      `}</style>

      <div className="ml-root" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div className="ml-breathe">
